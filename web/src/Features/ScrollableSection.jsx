    ...
    <section className="py-6">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          {seeAllLink && (
            <a href={seeAllLink} className="text-yellow-600 text-sm font-medium hover:text-yellow-700 transition-colors flex items-center gap-1">
              See All 
        ...
        <div className="relative">
          ...
          >
            {items.length === 0 ? (
              <div className="text-gray-500 text-center py-8 w-full">No items available</div>
            ) : items.length <= 3 ? (
